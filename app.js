...
function handler (request, response) {
	if (request.url == "/socket-io.js"){ response.setHeader("Content-Type", "application/javascript"); }
	if (request.url == "/simplewebrtc-bundle2.js"){ response.setHeader("Content-Type", "application/javascript"); }
